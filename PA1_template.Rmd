...
The mean number of steps taken is now `r prettyNum(as.integer(meanSteps), big.mark=",")` and the median number of steps taken is now `r prettyNum(medianSteps, big.mark=",")`.
